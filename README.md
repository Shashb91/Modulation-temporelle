...
* **Schémas de calcul :** `schema.py` (homogène), `schema\_mt.py` (modulations temporelles via splitting), `schema\_aniso.py` (milieux stratifiés).
...
* **Scripts de pilotage :** `main.py`, `main\_mt.py`, `main\_aniso.py`.
