...
tracer_cauchy_comparaison(data2, data1, data4_, 0.0)
tracer_cauchy_comparaison(data2, data1, data4_, 0.175)
...
tracer_cauchy_comparaison(data2, data3, data5_, 0.0)
tracer_cauchy_comparaison(data2, data3, data5_, 0.175)