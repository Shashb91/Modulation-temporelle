...
data1 = Donnee1D(M = 800,N = 2, label = "Lax Wendroff")                                #Lax Wendroff
data2 = Donnee1D(M = 800,N = 2, label = "Analytique")                                  #ADER4
data3 = Donnee1D(M = 800, label = "ADER4")                                       #Solution analytique
