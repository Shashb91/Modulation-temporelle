...
data1 = Donnee1D(M = 2000, label = "ADER4_f=" + str(f_mt) + "-Hz_mt=" + modulation, eps_r = eps, eps_E=eps, omega = f_mt*2*np.pi,
                 tc = (0, 0.4), xc = (0,2000), CFL = CFL, f = 10, rho_mt=rho, E_mt=E, alpha = alpha)

#Resolution
U = ADER41D_mt(data1)


# data1 = charger('.save/ADER4_f=3-Hz_mt=echelon_06-17_12-08-10.pkl')
print(data1)
