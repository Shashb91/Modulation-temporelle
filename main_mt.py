...
data1 = Donnee1D(M = 2000, label ="LW_mt=" + modulation, eps_r = -eps, eps_E=eps, omega =f_mt * 2 * np.pi,
                 tc = (0, 1), xc = (0,1200), c=1500, rho=1000, CFL=0.6, kappa=2.25e9, f = 20, rho_mt=rho, E_mt=E, param = param)
# data2 = Donnee1D(M = 200, label = "ADER4_mt=" + modulation, eps_r = -eps, eps_E=eps, omega = f_mt*2*np.pi,
#                  tc = (0, 0.5), xc = (0,1200), CFL = 0.95, f = 20, rho_mt=rho, E_mt=E, param = param)
...
LW1D_cauchy_mt = Donnee1D(M = 100, label ="LW1D_mt=0", eps_r = 0, eps_E=0, omega =f_mt * 2 * np.pi, S=pt_source_1D,
                          c=1500, rho=1000, CFL=0.6, kappa=2.25e9, tc = (0, 0.2), xc = (0, 500), f = 10, rho_mt=rho, E_mt=E, param = param)
...
#                               c=1500, rho=1000, CFL=0.6, e=2.25e9,tc = (0, 0.2), xc = (0,400), f = 10, rho_mt=rho, E_mt=E, param = param)
...
LW2D_mt = Donnee2D(Mx = 100, My = 100, label ="LW2D_mt=0", eps_r = 0, eps_E=0, omega =f_mt * 2 * np.pi, c=1500, rho=1000, kappa=2.25e9,
                   tc = (0, 1), xc = (0,400), yc = (0, 400), CFL = 0.6, f = 10, rho_mt=rho, E_mt=E, param = param)
...
ADER4_2D_mt = Donnee2D(Mx = 100, My = 100, label ="ADER4_mt=0", eps_r = -eps, eps_E=eps, omega =f_mt * 2 * np.pi,
                       tc = (0, 0.2), xc = (0,400), yc = (0, 400), CFL = 0.6, f = 10, rho_mt=rho, E_mt=E, param = param)
...
LW2D_cauchy_mt = Donnee2D(label = 'LW2D_mt=' + modulation, eps_r = -eps, eps_E=eps, omega =f_mt * 2 * np.pi, Mx = 100, My = 100, S=pt_source_1D,
                          c=1500, rho=1000, CFL=0.6, kappa=2.25e9, tc = (0, 0.2), xc = (0, 400), yc = (0, 400), f = 10, rho_mt=rho, E_mt=E, param = param)
