...
from schema import LaxWendroff2D, LaxWendroff1D_cauchy, ADER42D
...
modulation = "echelon"
alpha = 0.5
eps = 0.1                            # |eps| << 1, eps = 0 -> pas de modulation
...
ADER4_1D_cauchy_mt = Donnee1D(M = 200, label ="ADER4_1D_mt=" + modulation, eps_r = -eps, eps_E=eps, omega =f_mt * 2 * np.pi, S=pt_source_1D,
                          c=1500, rho=1000, CFL=0.6, e=2.25e9,tc = (0, 0.2), xc = (0,500), f = 10, rho_mt=rho, E_mt=E, alpha = alpha)
LaxWendroff1D_cauchy_mt(ADER4_1D_cauchy_mt)
anim1D_mt(ADER4_1D_cauchy_mt)

ADER4_1D_cauchy = Donnee1D(M = 500, label ="ADER4_", tc = (0, 0.5), xc = (0,1200), CFL = 0.95, f = 20)
LaxWendroff1D_cauchy(ADER4_1D_cauchy)
...
ADER4_2D_cauchy_mt = Donnee2D(label = 'ADER4_2D_mt=' + modulation, eps_r = -eps, eps_E=eps, omega =f_mt * 2 * np.pi, Mx = 200, My = 200, S=pt_source_1D,
                          c=1500, rho=1000, CFL=0.6, e=2.25e9,tc = (0, 0.2), xc = (0,500), yc = (0, 500), f = 10, rho_mt=rho, E_mt=E, alpha = alpha)

ADER42D_cauchy_mt(ADER4_2D_cauchy_mt)
sauvegarder(ADER4_2D_cauchy_mt)
# ADER4_2D_cauchy_mt = charger('.save/ADER4_2D_mt=echelon_06-26_12-03-28.pkl')
anim2D(ADER4_2D_cauchy_mt)

ADER4_2D_cauchy_mt_x = ADER4_2D_cauchy_mt.projection((75, 0))
