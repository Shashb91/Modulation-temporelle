...
alpha = 0.5
eps = 0.5                                    #0 < eps <<1
CFL = 0.65              #correction de la CFL avec la modulation
...
data1 = Donnee1D(M = 2000, label = "ADER4_f=" + str(f_mt) + "-Hz_mt=" + modulation, eps = eps, omega = f_mt*2*np.pi,
                 tc = (0, 0.185), xc = (0,1000), CFL = CFL, f = 10, rho_mt=rho, E_mt=E)
